    ...
    public class GerarBoletoPdf
    {
        ...
        public bool executar()
        {
            ...
            try
            {
                ...
                {
                    if (System.IO.File.Exists(path_imagens + logomarca))
                    {
                ...
                {
                    if (System.IO.File.Exists(path_imagens + background_imgem))
                    {
                ...
                //fontes =============================================================================================
                Font fntTableFont6 = FontFactory.GetFont("Arial", 6, iTextSharp.text.Font.NORMAL, BaseColor.BLACK);

                Font fntTableFont6Bold = FontFactory.GetFont("Arial", 6, iTextSharp.text.Font.BOLD, BaseColor.DARK_GRAY);

                Font fntParagrafoCourierFont6 = FontFactory.GetFont(FontFactory.COURIER, 8, iTextSharp.text.Font.NORMAL, BaseColor.BLACK);

                Font fntTableFont8Bold = FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.BOLD, BaseColor.DARK_GRAY);

                Font fntTableFont8 = FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL, BaseColor.BLACK);
                Font fntTableFont10 = FontFactory.GetFont("Arial", 10, iTextSharp.text.Font.BOLD, BaseColor.BLACK);
                Font fntTableFont12 = FontFactory.GetFont("Arial", 12, iTextSharp.text.Font.NORMAL, BaseColor.BLACK);
                Font fntTableFont18 = FontFactory.GetFont("Arial", 18, iTextSharp.text.Font.BOLD, BaseColor.BLACK);
                //fontes =============================================================================================

                Document doc = new Document(iTextSharp.text.PageSize.A4, 20, 20, 20, 20);

                PdfWriter wri = PdfWriter.GetInstance(doc, new FileStream(path_do_pdf + none_do_pdf, FileMode.Create));
                ...
                if (logo == null)
                {
                    PdfPCell tr1td1 = new PdfPCell(new Phrase(nome_do_banco, fntTableFont18));
                ...
                else
                {
                    ...
                    PdfPCell tr1td1 = new PdfPCell(logo, true);//(new Phrase("Banco Itaú S.A. ", fntTableFont10));
                ...
                PdfPCell tr1td2 = new PdfPCell(new Phrase(no_do_banco, fntTableFont18));
                tr1td2.VerticalAlignment = Element.ALIGN_MIDDLE;
                tr1td2.HorizontalAlignment = Element.ALIGN_CENTER;
                myTable.AddCell(tr1td2);

                PdfPCell tr1td3 = new PdfPCell(new Phrase(no_divitavel, fntTableFont10));//"Recibo do Sacado 	"
                ...
                ///<tr2>==========================================================================
                PdfPTable tr2td1_table1 = new PdfPTable(3);
                ...
                //------------------------------------------------------------------------------
                PdfPTable tr2td1_table1_tb1td1 = new PdfPTable(1);
                tr2td1_table1_tb1td1.TotalWidth = 100;
                PdfPCell tr1table1td1 = new PdfPCell(new Phrase("Cedente / CNPJ Cedente", fntTableFont6));
                ...
                PdfPCell tr1table1td2 = new PdfPCell(new Phrase(cedente + " / " + CD_Inscricao_Nacional, fntTableFont6Bold));
                tr1table1td2.Border = Rectangle.NO_BORDER;
                tr1table1td1.VerticalAlignment = Element.ALIGN_MIDDLE;
                tr2td1_table1_tb1td1.AddCell(tr1table1td2);
                //------------------------------------------------------------------------------    
                PdfPCell tb2tr1td1 = new PdfPCell();
                tr2td1_table1.AddCell(tr2td1_table1_tb1td1);
                //------------------------------------------------------------------------------

                PdfPTable tr2td1_table1_tb2td1 = new PdfPTable(1);
                tr2td1_table1_tb2td1.TotalWidth = 100;
                PdfPCell tr1table2td1 = new PdfPCell(new Phrase("Agência / Cód. Cedente", fntTableFont6));
                tr1table2td1.Border = Rectangle.NO_BORDER;
                tr2td1_table1_tb2td1.AddCell(tr1table2td1);
                PdfPCell tr1table2td2 = new PdfPCell(new Phrase(agencia_cod_cedente, fntTableFont6Bold));
                tr1table2td2.Border = Rectangle.NO_BORDER;
                tr2td1_table1_tb2td1.AddCell(tr1table2td2);
                //------------------------------------------------------------------------------
                PdfPCell tb2tr1td2 = new PdfPCell(tr2td1_table1_tb2td1);
                tr2td1_table1.AddCell(tb2tr1td2);
                //------------------------------------------------------------------------------
                PdfPTable tr2td1_table1_tb3td1 = new PdfPTable(1);
                tr2td1_table1_tb3td1.TotalWidth = 100;
                PdfPCell tr1table3td1 = new PdfPCell(new Phrase("Vencimento", fntTableFont6));
                tr1table3td1.Border = Rectangle.NO_BORDER;
                tr2td1_table1_tb3td1.AddCell(tr1table3td1);
                PdfPCell tr1table3td2 = new PdfPCell(new Phrase(vencimento, fntTableFont8Bold));
                ...
                //------------------------------------------------------------------------------
                PdfPCell tb2tr1td3 = new PdfPCell(tr2td1_table1_tb3td1);
                tr2td1_table1.AddCell(tb2tr1td3);


                ///AQUI==========================================================================
                PdfPCell tr2td1 = new PdfPCell(tr2td1_table1);
                tr2td1.Colspan = 3;
                ...
                PdfPTable tr3td1_table1 = new PdfPTable(2);
                ...
                //------------------------------------------------------------------------------
                PdfPTable tr3td1_table1_tb1td1 = new PdfPTable(1);
                tr3td1_table1_tb1td1.TotalWidth = 100;
                PdfPCell tr2table2td1 = new PdfPCell(new Phrase("Sacado - CNPJ/CPF", fntTableFont6));
                tr2table2td1.Border = Rectangle.NO_BORDER;
                tr3td1_table1_tb1td1.AddCell(tr2table2td1);
                PdfPCell tr2table2td2 = new PdfPCell(new Phrase(sacado, fntTableFont8Bold));
                tr2table2td2.Border = Rectangle.NO_BORDER;
                tr3td1_table1_tb1td1.AddCell(tr2table2td2);
                //------------------------------------------------------------------------------
                PdfPCell tb2tr2td1 = new PdfPCell();
                tb2tr2td1.Colspan = 2;
                tr3td1_table1.AddCell(tr3td1_table1_tb1td1);

                //------------------------------------------------------------------------------
                PdfPTable tr3td2_table1_tb2td1 = new PdfPTable(1);
                tr3td2_table1_tb2td1.TotalWidth = 100;
                PdfPCell tr2table3td1 = new PdfPCell(new Phrase("Valor do Documento", fntTableFont6));
                tr2table3td1.Border = Rectangle.NO_BORDER;
                tr3td2_table1_tb2td1.AddCell(tr2table3td1);
                PdfPCell tr2table3td2 = new PdfPCell(new Phrase(valor_do_documento, fntTableFont8Bold));
                ...
                //------------------------------------------------------------------------------
                PdfPCell tb2tr2td2 = new PdfPCell(tr3td2_table1_tb2td1);
                tr3td1_table1.AddCell(tb2tr2td2);


                ///</tr3>AQUI==========================================================================
                PdfPCell tr3td1 = new PdfPCell(tr3td1_table1);
                tr3td1.Colspan = 3;
                ...
                ///<tr4>==========================================================================
                PdfPTable tr4td1_table1 = new PdfPTable(2);
                ...
                //------------------------------------------------------------------------------
                PdfPTable tr4td1_table1_tb1td1 = new PdfPTable(1);
                tr4td1_table1_tb1td1.TotalWidth = 100;
                PdfPCell tr4table2td1 = new PdfPCell(new Phrase("Instruções", fntTableFont6));
                ...
                PdfPCell tr4table2td2 = new PdfPCell(new Phrase(instrucoes, fntTableFont8Bold));
                tr4table2td2.Border = Rectangle.NO_BORDER;
                tr4td1_table1_tb1td1.AddCell(tr4table2td2);
                //------------------------------------------------------------------------------
                PdfPCell tb2tr4td1 = new PdfPCell();
                tb2tr4td1.Colspan = 2;
                ...
                PdfPTable tr4td2_table2_tb2td1 = new PdfPTable(1);
                tr4td2_table2_tb2td1.TotalWidth = 100;

                //wwwwwwwwwwww----------------------------------------------------------------
                PdfPTable tr4td2_table1_tb2td1 = new PdfPTable(1);
                tr4td2_table1_tb2td1.TotalWidth = 100;
                PdfPCell tr4table3td1 = new PdfPCell(new Phrase("Nosso Número", fntTableFont6));
                tr4table3td1.Border = Rectangle.NO_BORDER;
                tr4td2_table1_tb2td1.AddCell(tr4table3td1);
                PdfPCell tr4table3td2 = new PdfPCell(new Phrase(nosso_numero, fntTableFont8Bold));
                ...
                PdfPCell tr4table3td1td1 = new PdfPCell(tr4td2_table1_tb2td1);
                tr4td2_table2_tb2td1.AddCell(tr4table3td1td1);

                //wwwwwwwwwwww----------------------------------------------------------------
                PdfPTable tr4td2_table2_tb3td1 = new PdfPTable(1);
                tr4td2_table2_tb3td1.TotalWidth = 100;
                PdfPCell tr4table3td3 = new PdfPCell(new Phrase("Nº do Documento", fntTableFont6));
                tr4table3td3.Border = Rectangle.NO_BORDER;
                tr4td2_table2_tb3td1.AddCell(tr4table3td3);
                PdfPCell tr4table3td4 = new PdfPCell(new Phrase(no_do_documento, fntTableFont8Bold));
                ...
                PdfPCell tr4table3td2td2 = new PdfPCell(tr4td2_table2_tb3td1);
                tr4table3td2td2.HorizontalAlignment = Element.ALIGN_RIGHT;
                tr4td2_table2_tb2td1.AddCell(tr4table3td2td2);


                //------------------------------------------------------------------------------
                PdfPCell tb2tr4td2 = new PdfPCell(tr4td2_table2_tb2td1);
                tr4td1_table1.AddCell(tb2tr4td2);


                ///</tr4>AQUI==========================================================================
                PdfPCell tr4td1 = new PdfPCell(tr4td1_table1);
                tr4td1.Colspan = 3;
                ...
                PdfPCell bottom = new PdfPCell(new Phrase("Autenticação Mecânica", fntTableFont6));
               ...
               // Chunk linebreak = new Chunk(new iTextSharp.text.pdf.draw.DottedLineSeparator());
                ...
                if (logo == null)
                {
                    PdfPCell my2tr1td1 = new PdfPCell(new Phrase(nome_do_banco, fntTableFont18));
                ...
                else
                {
                    ...
                    PdfPCell my2tr1td1 = new PdfPCell(logo, true);//(new Phrase("Banco Itaú S.A. ", fntTableFont10));
                ...
                PdfPCell my2tr1td2 = new PdfPCell(new Phrase(no_do_banco, fntTableFont18));
                ...
                PdfPCell my2tr1td3 = new PdfPCell(new Phrase(no_divitavel, fntTableFont10));
                ...
                ///<tr2>==========================================================================
                #region <TR2>
                PdfPTable my2tr2td1_table1 = new PdfPTable(2);
                ...
                //------------------------------------------------------------------------------
                PdfPTable my2tr2td1_table1_tb1td1 = new PdfPTable(1);
                my2tr2td1_table1_tb1td1.TotalWidth = 100;
                PdfPCell my2tr2table2td1 = new PdfPCell(new Phrase("Local de pagamento", fntTableFont6));
                my2tr2table2td1.Border = Rectangle.NO_BORDER;
                my2tr2td1_table1_tb1td1.AddCell(my2tr2table2td1);
                PdfPCell my2tr2table2td2 = new PdfPCell(new Phrase(local_de_pagamento, fntTableFont8Bold));
                my2tr2table2td2.Border = Rectangle.NO_BORDER;
                my2tr2td1_table1_tb1td1.AddCell(my2tr2table2td2);
                //------------------------------------------------------------------------------
                PdfPCell my2tb2tr2td1 = new PdfPCell();
                my2tb2tr2td1.Colspan = 2;
                my2tr2td1_table1.AddCell(my2tr2td1_table1_tb1td1);

                //-A mesma de cima-----------------------------------------------------------------------------
                PdfPCell my2tb2tr2td2 = new PdfPCell(tr2td1_table1_tb3td1);
                my2tr2td1_table1.AddCell(my2tb2tr2td2);


                ///</tr2>AQUI==========================================================================
                PdfPCell my2tr2td1 = new PdfPCell(my2tr2td1_table1);
                my2tr2td1.Colspan = 3;
                ...
                #region <TR3>
                PdfPTable my2tr3td1_table1 = new PdfPTable(2);
                ...
                //------------------------------------------------------------------------------
                PdfPTable my2tr3td1_table1_tb1td1 = new PdfPTable(1);
                my2tr3td1_table1_tb1td1.TotalWidth = 100;
                PdfPCell my2tr3table2td1 = new PdfPCell(new Phrase("Cedente / CNPJ Cedente", fntTableFont6));
                my2tr3table2td1.Border = Rectangle.NO_BORDER;
                my2tr3td1_table1_tb1td1.AddCell(my2tr3table2td1);
                PdfPCell my2tr3table2td2 = new PdfPCell(new Phrase(cedente + " / " + CD_Inscricao_Nacional, fntTableFont8Bold));
                my2tr3table2td2.Border = Rectangle.NO_BORDER;
                my2tr3td1_table1_tb1td1.AddCell(my2tr3table2td2);
                //------------------------------------------------------------------------------
                PdfPCell my2tb2tr3td1 = new PdfPCell();
                my2tb2tr3td1.Colspan = 2;
                my2tr3td1_table1.AddCell(my2tr3td1_table1_tb1td1);
                //------------------------------------------------------------------------------
                PdfPTable my2tr3td2_table1_tb2td1 = new PdfPTable(1);
                my2tr3td2_table1_tb2td1.TotalWidth = 100;
                PdfPCell my2tr2table3td1 = new PdfPCell(new Phrase("Agência / Cód. Cedente", fntTableFont6));
                my2tr2table3td1.Border = Rectangle.NO_BORDER;
                my2tr3td2_table1_tb2td1.AddCell(my2tr2table3td1);
                PdfPCell my2tr2table3td2 = new PdfPCell(new Phrase(agencia_cod_cedente, fntTableFont8Bold));
                ...
                //------------------------------------------------------------------------------
                PdfPCell my2tb2tr3td2 = new PdfPCell(my2tr3td2_table1_tb2td1);
                my2tr3td1_table1.AddCell(my2tb2tr3td2);


                ///</tr3>AQUI==========================================================================
                PdfPCell my2tr3td1 = new PdfPCell(my2tr3td1_table1);
                my2tr3td1.Colspan = 3;
                ...
                #region <TR4>
                PdfPTable my2tr4td1_table1 = new PdfPTable(6);
                ...
                //111------------------------------------------------------------------------------
                PdfPTable my2tr4td1_table1_tb1td1 = new PdfPTable(1);
                my2tr4td1_table1_tb1td1.TotalWidth = 100;
                //-----------------
                PdfPCell my2tr4table1td1 = new PdfPCell(new Phrase("Data do documento", fntTableFont6));
                my2tr4table1td1.Border = Rectangle.NO_BORDER;
                my2tr4td1_table1_tb1td1.AddCell(my2tr4table1td1);
                //-----------------
                PdfPCell my2tr4table1td2 = new PdfPCell(new Phrase(data_do_documento, fntTableFont8Bold));
                my2tr4table1td2.Border = Rectangle.NO_BORDER;
                my2tr4td1_table1_tb1td1.AddCell(my2tr4table1td2);
                //111------------------------------------------------------------------------------
                PdfPCell my2tb2tr4td1 = new PdfPCell();
                my2tb2tr4td1.Colspan = 2;
                my2tr4td1_table1.AddCell(my2tr4td1_table1_tb1td1);
                //111----------------------------------------------------------------------------

                //333------------------------------------------------------------------------------
                PdfPTable my2tr4td2_table1_tb3td3 = new PdfPTable(1);
                my2tr4td2_table1_tb3td3.TotalWidth = 100;
                //-----------------
                PdfPCell my2tr4table3td1 = new PdfPCell(new Phrase("Nº documento", fntTableFont6));
                my2tr4table3td1.Border = Rectangle.NO_BORDER;
                my2tr4td2_table1_tb3td3.AddCell(my2tr4table3td1);
                //-----------------
                PdfPCell my2tr4table3td2 = new PdfPCell(new Phrase(no_do_documento, fntTableFont8Bold));
                ...
                //333------------------------------------------------------------------------------
                PdfPCell my2tb3tr4td2 = new PdfPCell(my2tr4td2_table1_tb3td3);
                my2tr4td1_table1.AddCell(my2tb3tr4td2);
                //333----------------------------------------------------------------------------

                //444------------------------------------------------------------------------------
                PdfPTable my2tr4td2_table1_tb4td4 = new PdfPTable(1);
                my2tr4td2_table1_tb4td4.TotalWidth = 100;
                //-----------------
                PdfPCell my2tr4table4td1 = new PdfPCell(new Phrase("Espécie doc.", fntTableFont6));
                my2tr4table4td1.Border = Rectangle.NO_BORDER;
                my2tr4td2_table1_tb4td4.AddCell(my2tr4table4td1);
                //-----------------
                PdfPCell my2tr4table4td2 = new PdfPCell(new Phrase(especie_doc, fntTableFont8Bold));
                ...
                //444------------------------------------------------------------------------------
                PdfPCell my2tb4tr4td2 = new PdfPCell(my2tr4td2_table1_tb4td4);
                my2tr4td1_table1.AddCell(my2tb4tr4td2);
                //444----------------------------------------------------------------------------


                //555------------------------------------------------------------------------------
                PdfPTable my2tr4td2_table1_tb5td5 = new PdfPTable(1);
                my2tr4td2_table1_tb5td5.TotalWidth = 100;
                //-----------------
                PdfPCell my2tr4table5td1 = new PdfPCell(new Phrase("Aceite", fntTableFont6));
                my2tr4table5td1.Border = Rectangle.NO_BORDER;
                my2tr4td2_table1_tb5td5.AddCell(my2tr4table5td1);
                //-----------------
                PdfPCell my2tr4table5td2 = new PdfPCell(new Phrase(aceite, fntTableFont8Bold));
                ...
                //555------------------------------------------------------------------------------
                PdfPCell my2tb5tr4td2 = new PdfPCell(my2tr4td2_table1_tb5td5);
                my2tr4td1_table1.AddCell(my2tb5tr4td2);
                //555----------------------------------------------------------------------------

                //666------------------------------------------------------------------------------
                PdfPTable my2tr4td2_table1_tb6td6 = new PdfPTable(1);
                my2tr4td2_table1_tb6td6.TotalWidth = 100;
                //-----------------
                PdfPCell my2tr4table6td1 = new PdfPCell(new Phrase("Data processamento", fntTableFont6));
                my2tr4table6td1.Border = Rectangle.NO_BORDER;
                my2tr4td2_table1_tb6td6.AddCell(my2tr4table6td1);
                //-----------------
                PdfPCell my2tr4table6td2 = new PdfPCell(new Phrase(data_processamento, fntTableFont8Bold));
                ...
                //666------------------------------------------------------------------------------
                PdfPCell my2tb6tr4td2 = new PdfPCell(my2tr4td2_table1_tb6td6);
                my2tr4td1_table1.AddCell(my2tb6tr4td2);
                //666----------------------------------------------------------------------------


                //777------------------------------------------------------------------------------
                PdfPTable my2tr4td2_table1_tb7td7 = new PdfPTable(1);
                my2tr4td2_table1_tb7td7.TotalWidth = 100;
                //-----------------
                PdfPCell my2tr4table7td1 = new PdfPCell(new Phrase("Nosso número", fntTableFont6));
                my2tr4table7td1.Border = Rectangle.NO_BORDER;
                my2tr4td2_table1_tb7td7.AddCell(my2tr4table7td1);
                //-----------------
                PdfPCell my2tr4table7td2 = new PdfPCell(new Phrase(nosso_numero, fntTableFont8Bold));
                ...
                //777------------------------------------------------------------------------------
                PdfPCell my2tb7tr4td2 = new PdfPCell(my2tr4td2_table1_tb7td7);
                ...
                ///</tr4>AQUI==========================================================================
                PdfPCell my2tr4td1 = new PdfPCell(my2tr4td1_table1);
                my2tr4td1.Colspan = 3;
                ...
                #region <TR5>
                PdfPTable my2tr5_td1_table1 = new PdfPTable(6);
                ...
                //333------------------------------------------------------------------------------
                PdfPCell my2_tb3_tr5_td2 = new PdfPCell(my2_tr5_td2_table1_tb3td3);
                my2tr5_td1_table1.AddCell(my2_tb3_tr5_td2);
                //333----------------------------------------------------------------------------

                //444------------------------------------------------------------------------------
                PdfPTable my2_tr5_td2_table1_tb4td4 = new PdfPTable(1);
                my2_tr5_td2_table1_tb4td4.TotalWidth = 100;
                //-----------------
                PdfPCell my2_tr5_table4_td1 = new PdfPCell(new Phrase("Espécie", fntTableFont6));
                my2_tr5_table4_td1.Border = Rectangle.NO_BORDER;
                my2_tr5_td2_table1_tb4td4.AddCell(my2_tr5_table4_td1);
                //-----------------
                PdfPCell my2_tr5_table4_td2 = new PdfPCell(new Phrase(especie, fntTableFont8Bold));
                ...
                //444------------------------------------------------------------------------------
                PdfPCell my2_tb4_tr5_td2 = new PdfPCell(my2_tr5_td2_table1_tb4td4);
                my2tr5_td1_table1.AddCell(my2_tb4_tr5_td2);
                //444----------------------------------------------------------------------------


                //555------------------------------------------------------------------------------
                PdfPTable my2_tr5_td2_table1_tb5td5 = new PdfPTable(1);
                my2_tr5_td2_table1_tb5td5.TotalWidth = 100;
                //-----------------
                PdfPCell my2_tr5_table5_td1 = new PdfPCell(new Phrase("Quantidade", fntTableFont6));
                my2_tr5_table5_td1.Border = Rectangle.NO_BORDER;
                my2_tr5_td2_table1_tb5td5.AddCell(my2_tr5_table5_td1);
                //-----------------
                PdfPCell my2_tr5_table5_td2 = new PdfPCell(new Phrase(quantidade, fntTableFont8Bold));
                ...
                //555------------------------------------------------------------------------------
                PdfPCell my2_tb5_tr5_td2 = new PdfPCell(my2_tr5_td2_table1_tb5td5);
                my2tr5_td1_table1.AddCell(my2_tb5_tr5_td2);
                //555----------------------------------------------------------------------------

                //666------------------------------------------------------------------------------
                PdfPTable my2_tr5_td2_table1_tb6td6 = new PdfPTable(1);
                my2_tr5_td2_table1_tb6td6.TotalWidth = 100;
                //-----------------
                PdfPCell my2_tr5_table6_td1 = new PdfPCell(new Phrase("Valor documento", fntTableFont6));
                my2_tr5_table6_td1.Border = Rectangle.NO_BORDER;
                my2_tr5_td2_table1_tb6td6.AddCell(my2_tr5_table6_td1);
                //-----------------
                PdfPCell my2_tr5_table6_td2 = new PdfPCell(new Phrase(valor_do_documento, fntTableFont8Bold));
                ...
                //666------------------------------------------------------------------------------
                PdfPCell my2_tb6_tr5_td2 = new PdfPCell(my2_tr5_td2_table1_tb6td6);
                my2tr5_td1_table1.AddCell(my2_tb6_tr5_td2);
                //666----------------------------------------------------------------------------


                //777------------------------------------------------------------------------------
                PdfPTable my2_tr5_td2_table1_tb7td7 = new PdfPTable(1);
                my2_tr5_td2_table1_tb7td7.TotalWidth = 100;
                //-----------------
                PdfPCell my2_tr5_table7_td1 = new PdfPCell(new Phrase("(=) Valor do documento", fntTableFont6));
                my2_tr5_table7_td1.Border = Rectangle.NO_BORDER;
                my2_tr5_td2_table1_tb7td7.AddCell(my2_tr5_table7_td1);
                //-----------------
                PdfPCell my2_tr5_table7_td2 = new PdfPCell(new Phrase(valor_do_documento, fntTableFont8Bold));
                ...
                //777------------------------------------------------------------------------------
                PdfPCell my2_tb7_tr5_td2 = new PdfPCell(my2_tr5_td2_table1_tb7td7);
                ...
                ///</tr5>AQUI==========================================================================
                PdfPCell my2_tr5_td1 = new PdfPCell(my2tr5_td1_table1);
                ...
                #region <TR7>
                ///<tr4>==========================================================================
                PdfPTable tr7_td1_table1 = new PdfPTable(2);
                ...
                //------------------------------------------------------------------------------
                PdfPTable tr7_td1_table1_tb1td1 = new PdfPTable(1);
                tr7_td1_table1_tb1td1.TotalWidth = 100;
                PdfPCell tr7_table2_td1 = new PdfPCell(new Phrase("Instruções (Texto de responsabilidade do cedente)", fntTableFont6));
                ...
                PdfPCell tr7_table2_td2 = new PdfPCell(new Phrase(instrucoes, fntTableFont8Bold));
                tr7_table2_td2.Border = Rectangle.NO_BORDER;
                tr7_td1_table1_tb1td1.AddCell(tr7_table2_td2);
                //------------------------------------------------------------------------------
                PdfPCell tb2_tr7_td1 = new PdfPCell();
                ...
                PdfPTable tr7_td2_table2_tb2_td1 = new PdfPTable(1);
                tr7_td2_table2_tb2_td1.TotalWidth = 100;
                //LINHA 1111 -----------------------------------------------------------------
                //wwwwwwwwwwww----------------------------------------------------------------
                PdfPTable tr7_td2_table1_tb2_td1 = new PdfPTable(1);
                tr7_td2_table1_tb2_td1.TotalWidth = 100;
                PdfPCell tr7_table3_td1 = new PdfPCell(new Phrase("(-) Desconto/Abatimentos", fntTableFont6));
                tr7_table3_td1.Border = Rectangle.NO_BORDER;
                tr7_td2_table1_tb2_td1.AddCell(tr7_table3_td1);
                PdfPCell tr7_table3_td2 = new PdfPCell(new Phrase(desconto_abatimentos, fntTableFont8Bold));
                ...
                PdfPCell tr7_table3_td1td1 = new PdfPCell(tr7_td2_table1_tb2_td1);
                tr7_td2_table2_tb2_td1.AddCell(tr7_table3_td1td1);
                //LINHA 1111 -----------------------------------------------------------------

                //LINHA 2222 -----------------------------------------------------------------
                //wwwwwwwwwwww----------------------------------------------------------------
                PdfPTable tr7_td2_table2_tb3_td1 = new PdfPTable(1);
                tr7_td2_table2_tb3_td1.TotalWidth = 100;
                PdfPCell tr7_table3_td3 = new PdfPCell(new Phrase("(-) Outras deduções", fntTableFont6));
                tr7_table3_td3.Border = Rectangle.NO_BORDER;
                tr7_td2_table2_tb3_td1.AddCell(tr7_table3_td3);
                PdfPCell tr7_table3_td4 = new PdfPCell(new Phrase(outras_deducoes, fntTableFont8Bold));
                ...
                PdfPCell tr7_table3_td2td2 = new PdfPCell(tr7_td2_table2_tb3_td1);
                ...
                //LINHA 3333 -----------------------------------------------------------------
                //wwwwwwwwwwww----------------------------------------------------------------
                PdfPTable tr7_td2_table3_tb4_td1 = new PdfPTable(1);
                tr7_td2_table3_tb4_td1.TotalWidth = 100;
                PdfPCell tr7_table3_td5 = new PdfPCell(new Phrase("(+) Mora/Multa", fntTableFont6));
                tr7_table3_td5.Border = Rectangle.NO_BORDER;
                tr7_td2_table3_tb4_td1.AddCell(tr7_table3_td5);
                PdfPCell tr7_table3_td6 = new PdfPCell(new Phrase(mora_multa, fntTableFont8Bold));
                ...
                PdfPCell tr7_table3_td3td3 = new PdfPCell(tr7_td2_table3_tb4_td1);
                tr7_td2_table2_tb2_td1.AddCell(tr7_table3_td3td3);
                //LINHA 3333 -------------------------------------------------------------------

                //LINHA 4444 -----------------------------------------------------------------
                //wwwwwwwwwwww----------------------------------------------------------------
                PdfPTable tr7_td2_table2_tb5_td1 = new PdfPTable(1);
                tr7_td2_table2_tb5_td1.TotalWidth = 100;
                PdfPCell tr7_table3_td7 = new PdfPCell(new Phrase("(+) Outros acréscimos", fntTableFont6));
                tr7_table3_td7.Border = Rectangle.NO_BORDER;
                tr7_td2_table2_tb5_td1.AddCell(tr7_table3_td7);
                PdfPCell tr7_table3_td8 = new PdfPCell(new Phrase(outros_acrescimos, fntTableFont8Bold));
                ...
                PdfPCell tr7_table3_td4td4 = new PdfPCell(tr7_td2_table2_tb5_td1);
                tr7_td2_table2_tb2_td1.AddCell(tr7_table3_td4td4);
                //LINHA 4444 -------------------------------------------------------------------

                //LINHA 5555 -----------------------------------------------------------------
                //wwwwwwwwwwww----------------------------------------------------------------
                PdfPTable tr7_td2_table2_tb6_td1 = new PdfPTable(1);
                tr7_td2_table2_tb6_td1.TotalWidth = 100;
                PdfPCell tr7_table3_td9 = new PdfPCell(new Phrase("(=) Valor cobrado", fntTableFont6));
                tr7_table3_td9.Border = Rectangle.NO_BORDER;
                tr7_td2_table2_tb6_td1.AddCell(tr7_table3_td9);
                PdfPCell tr7_table3_td10 = new PdfPCell(new Phrase(valor_cobrado, fntTableFont8Bold));
                ...
                PdfPCell tr7_table3_td5td5 = new PdfPCell(tr7_td2_table2_tb6_td1);
                tr7_td2_table2_tb2_td1.AddCell(tr7_table3_td5td5);
                //LINHA 5555 -------------------------------------------------------------------

                //------------------------------------------------------------------------------
                PdfPCell tb2_tr7_td2 = new PdfPCell(tr7_td2_table2_tb2_td1);
                tr7_td1_table1.AddCell(tb2_tr7_td2);


                ///</tr4>AQUI==========================================================================
                PdfPCell tr7_td1 = new PdfPCell(tr7_td1_table1);
                tr7_td1.Colspan = 3;
                ...
                PdfPCell sacado2 = new PdfPCell(new Phrase(sacado, fntTableFont8Bold));
                ...
                PdfPCell sacador = new PdfPCell(new Phrase("Sacador/Avalista:" + sacador_avalista, fntTableFont6));
                ...
                PdfPCell tr8_td1_table1 = new PdfPCell(tablesacado);//
                ...
                Codbarras.Append("<img src=\"" + path_imagens + "/p.gif\" width=\"" + fino.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
                Codbarras.Append("<img src=\"" + path_imagens + "/b.gif\" width=\"" + fino.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
                Codbarras.Append("<img src=\"" + path_imagens + "/p.gif\" width=\"" + fino.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
                Codbarras.Append("<img src=\"" + path_imagens + "/b.gif\" width=\"" + fino.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
                ...
                while (texto.Length > 0)
                {
                    ...
                    for (i = 0; i <= 9; i += 2)
                    {
                        ...
                        Codbarras.Append("<img src=\"" + path_imagens + "/p.gif\" width=\"" + f1.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");

                        if (s[i + 1] == '0') f2 = fino;
                        else f2 = largo;

                        Codbarras.Append("<img src=\"" + path_imagens + "/b.gif\" width=\"" + f2.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
                ...
                Codbarras.Append("<img src=\"" + path_imagens + "/p.gif\" width=\"" + largo.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
                Codbarras.Append("<img src=\"" + path_imagens + "/b.gif\" width=\"" + fino.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
                Codbarras.Append("<img src=\"" + path_imagens + "/p.gif\" width=\"" + fino.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
                ...
                PdfPCell cellcodbar = new PdfPCell();//tr9_td1_table1
                cellcodbar.Colspan = 3;
                cellcodbar.VerticalAlignment = Element.ALIGN_MIDDLE;

                List<IElement> htmlarraylist = HTMLWorker.ParseToList(new StringReader(Codbarras.ToString()), null);
                ...
                //table.LockedWidth = true;
                PdfPCell bottom2 = new PdfPCell(new Phrase("Autenticação Mecânica", fntTableFont6));
                ...
                PdfPCell bottom3 = new PdfPCell(new Phrase("Ficha de Compensação", fntTableFont6));
                ...
                PdfPCell bottom4 = new PdfPCell(cellcodbar);
                ...
                Chunk linebreak1 = new Chunk(new LineSeparator(1f, 100f, BaseColor.BLACK, Element.ALIGN_CENTER, -1));
