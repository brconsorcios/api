$(function () {
    ...
    //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    //Apagar ajax Solu��o para formul�rios
    $(".ApagarRegistro").click(function () {
        var rel = $(this).attr('rel');
        var rs = rel.split(";");
        jConfirm('Voc&ecirc; realmente deseja apagar?', 'Apagando', function (r) {
            if (r) {
                $.post(rs[0] + "?rnd=" + Math.random() + 300 % 2, {id: "" + rs[1] + ""},
                    function (data) {
                        if (data == "apagado") {
                            $("#" + rs[2]).fadeOut();
                            $.jGrowl("Apagado com sucesso!");
                        } else {
                            $.jGrowl("N&atilde;o foi poss&iacute;vel apagar!");
                        }
    ...
    //Atualizando Checkbox para MVC
    $(".AlterarCheckbox").live("click", function () {
        var two = "";// $(this).attr("checked", this.checked);
        var checked = $(this).attr('checked');
        if (checked != undefined) {
            two += $(this).attr("checked", true);
            two += $(this).attr("value", true);
            two += $(this).attr("data-val", true);
        } else {
            two += $(this).attr("checked", false);
            two += $(this).attr("value", false);
            two += $(this).attr("data-val", false);

        }
        $.uniform.update(two);
    });
    //Apagar ajax Solu��o para formul�rios
    $(".DeletarRegistro").click(function () {
        var obj = $(this);
        var url = obj.attr('rel');

        jConfirm('Voc&ecirc; realmente deseja apagar?', 'Apagando', function (r) {
            if (r) {
                $.get(url + "?rnd=" + Math.random() + 300 % 2,
                    function (data) {
                        if (data == "apagado") {
                            obj.closest("tr").fadeOut(); //.hide('fast'); //Hide Row
                            $.jGrowl("Apagado com sucesso!");
                        } else {
                            $.jGrowl("N&atilde;o foi poss&iacute;vel apagar!");
                        }
        ...
        $.get(url + "?rnd=" + Math.random() + 300 % 2,
            function (data) {
                if (data == "True") {
                    ...
                    obj.attr("class", "Ativar valtrue");
                    $.jGrowl("Ativado com sucesso!");
                } else {
                    obj.attr("class", "Ativar valfalse");
                    $.jGrowl("Desativado com sucesso!");
                }
...
//            var checked =  $('.AlterarCheckbox').attr('class');

//            

//            if (checked != undefined){
//                 $('.AlterarCheckbox').val(true);
//                 alert('true');
//            }else{
//                $('.AlterarCheckbox').val(false);
//                alert('false');
//            }   
//        });
    ...
    $('textarea.tinymce').tinymce({
        ...
        script_url: '/restrito/scripts/tiny_mce/tiny_mce.js',
        language: 'pt',
        width: "100%",
        height: "400",
        ...
        theme_advanced_buttons1: "newdocument,preview,|,cleanup,bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,ltr,rtl,|,visualchars,|,code,styleselect,template",
        ...
        // content_css: "/content/css/tiny_mce.css?i=2",
        content_css: "/restrito/scripts/tiny_mce/css/tiny_mce.css?i=editoradm",
        ...
        // html5 formats
        style_formats: [
            {title: 'subtitulo 1', inline: 'h3', classes: 'subtitulo1'},
            {title: 'subtitulo 2', inline: 'h4', classes: 'subtitulo2'},
            {title: 'legenda', block: 'span', classes: 'legenda'},
            {title: 'p', block: 'p'},
            {title: 'div', block: 'div'},
            {title: 'pre', block: 'pre'},
        ...
        template_templates: [
            {
                title: "citacao a esquerda do texto",
                src: "/restrito/scripts/tiny_mce/template/citacaoleft.htm",
                description: "cita��o a esquerda com aspas"
            },
            {
                title: "citacao a direita do texto",
                src: "/restrito/scripts/tiny_mce/template/citacaoright.htm",
                description: "cita��o a direita com aspas"
            },
            {
                title: "foto pequena com legenda",
                src: "/restrito/scripts/tiny_mce/template/foto300.htm",
                description: "foto pequena com legenda."
            },
            {
                title: "foto grande com legenda",
                src: "/restrito/scripts/tiny_mce/template/foto620.htm",
                description: "foto grande com legenda."
            },
            {
                title: "caixa de destaque",
                src: "/restrito/scripts/tiny_mce/template/caixadestaque.htm",
                description: "caixa de destaque."
            },
            {
                title: "tabela modelo 01",
                src: "/restrito/scripts/tiny_mce/template/table620.htm",
                description: "tabela modelo."
            }
            ,
            {
                title: "tabela modelo 02",
                src: "/restrito/scripts/tiny_mce/template/table620b.htm",
                description: "tabela modelo."
            }
            ,
            {
                title: "tabela modelo 03",
                src: "/restrito/scripts/tiny_mce/template/table620c.htm",
                description: "tabela modelo."
            }
            ,
            {
                title: "tabela modelo 04",
                src: "/restrito/scripts/tiny_mce/template/table620d.htm",
                description: "tabela modelo."
            }
            ,
            {
                title: "tabela modelo 05",
                src: "/restrito/scripts/tiny_mce/template/table620e.htm",
                description: "tabela modelo."
            }
        ],
    ...
    */
    ...
    $('.dtmonthpicker').MonthPicker({StartYear: y, ShowIcon: false});
