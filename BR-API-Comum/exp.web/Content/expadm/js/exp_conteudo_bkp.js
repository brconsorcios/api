...
$(function () {
    ...
    $('#fileupload').click(function () {
        ...
        if (name.length < 1) {
            ...
            $("#data").html(formData);
            $.ajax({
                url: '/inside/informativo/ajaxarquivos/?rnd=' + Math.random() + 300 % 2, //server script to process data
                type: 'POST',
                //Ajax events
                beforeSend: function () {
                    $('#ajax-panel').fadeIn();
...
$(".itemList").sortable(
    {
        ...
        update: function (event, ui) {
            ...
            $.post("/inside/informativo/AnexoUpdateSortOrder", {itemIdQueryString: $(this).sortable("serialize")});
        }
    });
