        ...
        newLang: function () {
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    "regex": "none",
                    "alertText": "* Este campo é necessário",
                    "alertTextCheckboxMultiple": "* Selecione uma opção",
                    "alertTextCheckboxe": "* Esta caixa de seleção é necessária",
                    "alertTextDateRange": "* Ambos os campos de intervalo de datas são obrigatórios"
                },
                "dateRange": {
                    "regex": "none",
                    "alertText": "* Inválido ",
                ...
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
                    "alertText": "* Não um inteiro válido"
                },
                "number": {
                    // Number, including positive, negative, and floating decimal. credit: orefalo
                    "regex": /^[\-\+]?(([0-9]+)([\.,]([0-9]+))?|([\.,]([0-9]+))?)$/,
                    "alertText": "* Número inválido decimal flutuante"
                },
                "date": {
                    "regex": /^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])$/,
                    "alertText": "* Data Inválido, deve ser no formato AAAA-MM-DD formato"
                },
                "ipv4": {
                ...
                "ajaxUserCall": {
                    ...
                    "alertTextLoad": "* Validando, aguarde"
                },
                "ajaxUserCallPhp": {
                    ...
                    "alertTextOk": "* Este nome de usuário está disponível",
                    "alertText": "* Este usuário já existe",
                    "alertTextLoad": "* Validando, aguarde"
                },
                "ajaxNameCall": {
                ...
                "dateTimeFormat": {
                    ...
                    "alertText": "* Formato de data  ou Data inválida",
